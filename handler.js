...
if (db.data.chats[m.chat].reaction && m.text.match(/(привет|как дела|дурак|бот|здраствуйте|🥰|Эвелина|tion|age|ous|ate|and|but|ify)/gi)) {
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '😻 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 😻', '🌟 centerЭвелина.gmail.com'].getRandom(), thumbnail: gataImg.getRandom(), sourceUrl: [md, yt, nna, nn, nnn, ig, paypal, fb].getRandom() }}}}, tg)
