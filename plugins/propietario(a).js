...
if (!fs.existsSync(`./Эвелина/${conn.user.jid.split`@`[0]}/creds.json`)) {
...
const path = conn.user.jid != global.conn.user.jid ? `./Эвелина/${conn.user.jid.split`@`[0]}/creds.json` : `./GataBotSession/creds.json`
